...
#define TIME_BETWEEN_CASES 20 // Picked 20 randomly. Seconds?

//Servo constants
#define SERVO_CLOSED 13 // Changed from 0 to 13 from Servo_Testing_JOHN
#define SERVO_OPEN   3  // Changed from 7 to 3 from Servo_Testing_JOHN

//Motor constants
#define DOWN LOW  // Changed from Z_DOWN to DOWN to match code
#define UP   HIGH // Changed from Z_UP to UP to match code
